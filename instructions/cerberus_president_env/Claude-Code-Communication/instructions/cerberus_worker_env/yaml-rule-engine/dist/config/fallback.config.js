...
exports.createFallbackConfig = exports.staticDefaultConfig = exports.llmConfig = exports.apiConfigs = exports.getEnvironmentConfig = exports.defaultFallbackConfig = void 0;
exports.defaultFallbackConfig = {
    stages: [], // 実装時に動的に追加
...
const createFallbackConfig = () => {
    const baseConfig = { ...exports.defaultFallbackConfig };
    const envConfig = (0, exports.getEnvironmentConfig)();
    // 環境設定をマージ
    return {
        ...baseConfig,
        ...envConfig,
...
exports.createFallbackConfig = createFallbackConfig;
